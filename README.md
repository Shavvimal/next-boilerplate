...
This is a [Next.js](https://nextjs.org/) project bootstrapped with [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app) with a couple of my preferred additions. This includes:
...
- App Directory
- Path Aliases for
  - `components`, `layouts`, `lib`, `styles`, `data`, `assets`, `types`
- `tailwind.config.js` includes `@tailwindcss/forms` as well as color definitions and more utilities
- Sass Options added to next.config
- Configure Next.js to import SVG as React components in your application using SVGR with `@svgr/webpack` according to [docs](https://react-svgr.com/docs/next/).
- Prisma ORM for DB connection
- Redux State Management for NextJS 13 Server and Client Components [Video](https://www.youtube.com/watch?v=dRLjoT4r-jc)
  - Application now using Redux during both SSR and CSR in a NextJS 13 application using the app directory
- basic API route for Auth & Data Fetching with Redux
...
- [Server side Components](https://nextjs.org/docs/getting-started/react-essentials)
- Data Fetching
...
[http://localhost:3000/api/hello](http://localhost:3000/api/hello) is an endpoint that uses [Route Handlers](https://nextjs.org/docs/app/building-your-application/routing/router-handlers). This endpoint can be edited in `app/api/hello/route.ts`.

This project uses [`next/font`](https://nextjs.org/docs/app/building-your-application/optimizing/fonts) to automatically optimize and load Rubik, a custom Google Font.

## Resource List

- [Next.js Documentation](https://nextjs.org/docs) - learn about Next.js features and API.
- [Next.js App Router Documentation](https://nextjs.org/docs/app/building-your-application/routing/intercepting-routes) - learn about Next.js features and API.
